...
#define AI_NETWORK_MODEL_SIGNATURE     "0xd97e90943a614eba86f31fc6a3d6dc5f"
...
#define AI_TOOLS_DATE_TIME   "2026-01-02T22:58:05+0300"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  10, 0x0,
  AI_SHAPE_INIT(4, 7, 100, 1, 1), AI_STRIDE_INIT(4, 4, 28, 2800, 2800),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 47640, 1, 1),
    47640, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 800, 1, 1),
    800, NULL, NULL),
  ...
  &dense_dense_layer, 0xac40a279, NULL)
