...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "mlp_kws_model"
...
#define AI_NETWORK_IN_1_CHANNEL     (208)
#define AI_NETWORK_IN_1_SIZE        (208)
#define AI_NETWORK_IN_1_SIZE_BYTES  (832)
